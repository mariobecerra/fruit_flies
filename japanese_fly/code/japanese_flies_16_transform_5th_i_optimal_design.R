...
write.csv(transformed_design_list$design_software, here("japanese_fly/out/5th_i_optimal_design_japanese_frank.csv"), row.names = F)
write.csv(transformed_design_list$design_with_mixture, here("japanese_fly/out/5th_i_optimal_design_japanese_mapping.csv"), row.names = F)
