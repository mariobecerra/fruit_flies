...
model_01_summary = readRDS(here("out/japanese_max_mnl_model_experiments_1_to_3_betas_summary.rds"))
...
i_opt_design_filename_flies_01 = paste0(here("out/japanese_flies_third_i_optimal_design.rds"))
