...
# saveRDS(model_stan_01, here("out/japanese_max_mnl_model_experiments_1_to_3_stan_object.rds"))
...
saveRDS(betas_model_01_summary, here("out/japanese_max_mnl_model_experiments_1_to_3_betas_summary.rds"))
