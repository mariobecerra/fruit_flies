...
simulated_data = readRDS(here("out/sims_out/model_1_level_sim_simulated_data_tibble_2023-05-04.rds"))
model_stan = readRDS(here("out/sims_out/model_1_level_sim_stan_object_2023-05-04.rds"))
