...
Sigma_level_2 = diag(0.001, ncol = length(beta_level_0), nrow = length(beta_level_0))
...
# 10 minutes for 4000 iterations and 6 experiments, 50 choice sets and 5 images per choice set
model_stan_lkj <- stan(
  file = here("simulation_code/08_hmnl_flies_2_levels.stan"),
  data = stan_data, 
  seed = 2023,
  # iter = 50, chains = 1, cores = 1)
  iter = 4000,  warmup = 3000, chains = 6, cores = 6)
  # iter = 1500,  warmup = 1000, chains = 6, cores = 6)
# iter = 3000,
# warmup = 2000,
# chains = 4,
# seed = 2023,
